  ...
  return (
    <header className="h-14 bg-white border-b border-slate-200 px-4 md:px-6 flex items-center justify-between z-30 sticky top-0 shadow-2xs">
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        >
          <div className="w-8 h-8 rounded-lg bg-indigo-600 group-hover:bg-indigo-500 text-white flex items-center justify-center shadow-xs transition-colors flex-shrink-0">
            <Layers className="w-4 h-4 stroke-[2.5]" />
          </div>
          <h1 className="text-sm sm:text-base font-black tracking-tight text-slate-900 whitespace-nowrap">
            B.E.A.M. <span className="text-indigo-600 hidden sm:inline">Calculator</span>
          </h1>
        </Link>

        {/* Subtle Equilibrium / Status Badge - Hidden on small mobile screens to prevent overflow */}
        {isStable ? (
          <div className="hidden md:flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-emerald-50 border border-emerald-200 text-[11px] font-semibold text-emerald-800">
          ...
          <div className="hidden md:flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-rose-50 border border-rose-200 text-[11px] font-bold text-rose-700">
      ...
      <div className="flex items-center space-x-1.5 sm:space-x-2">
        ...
        <button
          type="button"
          onClick={onOpenSteps}
          className="flex items-center space-x-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200/80 text-xs font-bold transition-all cursor-pointer shadow-2xs whitespace-nowrap"
        >
